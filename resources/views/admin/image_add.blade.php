            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card-body">
                            <form role="form" action="{{route('admin_image_store',['house_id'=>$data->id])}}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="card">
                                    <div class="card-body">
                            ...
                            <table id="zero_config" class="table table-striped table-bordered">
                                ...
                                @foreach( $images as $rs)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('admin_image_delete', ['id'=> $rs->id,'house_id'=>$data->id])}}" onclick="return confirm ('Are you sure?')" >
