                            ...
                            <form role="form" action="{{route('admin_review_update',['id'=>$data->id])}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="card">
                                    ...
                                    <table id="zero_config" class="table table-striped table-bordered">
                                        ...
                                        <tr>
                                            <th>Ürün</th> <td>{{$data->house->title}}</td>
                                        </tr>
                                        <tr>
                                            <th>Konu</th><td>{{$data->subject}}</td>
                                        </tr>
                                        <tr>
                                            <th>Yorum</th><td>{{$data->review}}</td>
                                        </tr>
                                        <tr>
                                            <th>Oy</th><td>{{$data->rate}}</td>
                                        </tr>
                                        <tr>
                                            <th>Ip</th><td>{{$data->ip}}</textarea>
                                            }}</td>

                                        </tr>
                                        <tr>
                                            <th>Oluşturma Tarihi</th><td>{{$data->created_at}}</td>
                                        </tr>
                                        <tr>
