...
<head>
    ...
    <title>EvciKus-Sıkça Sorulan Sorular</title>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading" role="tab" id="headingFour">
                        <h4 class="panel-title">
                            <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse{{$rs->position}}" aria-expanded="false" aria-controls="collapseFour">
                                <h4> {{$rs->question}}</h4>
                            </a>
                        </h4>
                    </div>
                    <div id="collapse{{$rs->position}}" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFour">
