...
class FaqController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $data->save();
        return redirect()->route('admin_faq')->with('success','SSK Kaydedildi.');
    }
    ...
    public function update(Request $request, Faq $faq,$id)
    {
        ...
        $data->save();
        return redirect()->route('admin_faq')->with('success','SSS Güncellemesi Kaydedildi.');
    }
    ...
    public function destroy(Faq $faq,$id)
    {
        ...
        return redirect()->route('admin_faq')->with('success','SSS Silindi.');
